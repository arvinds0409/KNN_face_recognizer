1. This is a K-nearest neighbor classifier trained on image dataset by fetching them from AWS S3 bucket using pre-built functions from global_functions which utilizes boto3.
